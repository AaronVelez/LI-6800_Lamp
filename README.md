...
|  The COB-LED is dimly ON even if the DAC1 voltage is set to 0V.  |  The zero offset of the XTR110 chip is not properly adjusted.  |  Adjust the zero offset of the XTR110 chip by following the instructions in Appendix 2.  |
